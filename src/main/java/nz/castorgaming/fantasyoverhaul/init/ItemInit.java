...
public final class ItemInit {
	...
	public static final FrozenHeart HEART_ICY = new FrozenHeart("heart_frozen", EnumAction.EAT, new PotionEffect[] {new PotionEffect(MobEffects.FIRE_RESISTANCE, 20)});
	...
	public static final DemonHeart HEART_DEMON = new DemonHeart("heart_demon", new PotionEffect[] { new PotionEffect(MobEffects.HEALTH_BOOST, 2400, 4), new PotionEffect(MobEffects.REGENERATION, 2400, 1), new PotionEffect(MobEffects.STRENGTH, 2400, 2), new PotionEffect(MobEffects.SPEED, 2400, 2), new PotionEffect(MobEffects.FIRE_RESISTANCE, 2400, 2), new PotionEffect(MobEffects.NAUSEA, 2400), new PotionEffect(MobEffects.HUNGER, 3600, 1) });
	public static final CreeperHeart HEART_CREEPER = new CreeperHeart("heart_creeper", EnumAction.EAT, new PotionEffect[] {new PotionEffect(MobEffects.FIRE_RESISTANCE, 20, 0)});
	...
	public static final Drinkable APPLE_WORMY = new Drinkable("apple_wormy", EnumAction.EAT, new PotionEffect[] {new PotionEffect(MobEffects.POISON, 60)});
	...
	public static final Drinkable SOUP_REDSTONE = new Drinkable("soup_redstone", new PotionEffect[] {new PotionEffect(MobEffects.HEALTH_BOOST, 2400, 1)});
	public static final Drinkable OINTMENT_FLYING = new Drinkable("ointment_flying", new PotionEffect[] {new PotionEffect(MobEffects.POISON, 1200, 2) });
	public static final Drinkable GHOST_LIGHT = new Drinkable("ghost_light", new PotionEffect[] {new PotionEffect(MobEffects.POISON, 1200, 1) });
	public static final Drinkable WORLD_SOUL = new Drinkable("world_soul", new PotionEffect[] {new PotionEffect(MobEffects.POISON, 1200, 1) });
	public static final Drinkable OTHERWHERE_SPIRIT = new Drinkable("otherwhere_spirit", new PotionEffect[] {new PotionEffect(MobEffects.POISON, 1200, 1) });
	public static final Drinkable INFERNAL_ANIMUS = new Drinkable("infernal_animus", new PotionEffect[] {new PotionEffect(MobEffects.POISON, 1200, 1), new PotionEffect(MobEffects.WITHER, 3600, 2)});
	public static final Drinkable MYSTIC_UNGUENT = new Drinkable("mystic_unguent", new PotionEffect[] {new PotionEffect(MobEffects.WEAKNESS, 1200, 1)});
	public static final Drinkable OIL_HAPPENSTANCE = new Drinkable("oil_happenstance", new PotionEffect[] {new PotionEffect(MobEffects.NIGHT_VISION, 1200)});
	...
	public static final Drinkable INFUSION_BASE = new Drinkable("infusion_base", new PotionEffect(MobEffects.WITHER, 200, 3));
	public static final Drinkable CONGEALED_SPIRIT = new Drinkable("congealed_spirit", new PotionEffect(MobEffects.NIGHT_VISION, TimeUtilities.secsToTicks(30), 1));	
	...
	//Dream Weaves
	public static final DreamWeave WEAVE_FAST_MOVE = new DreamWeave("weave_fast_move", MobEffects.SPEED, MobEffects.SLOWNESS, 7200, 0);
	public static final DreamWeave WEAVE_DIG = new DreamWeave("weave_dig", MobEffects.HASTE, MobEffects.MINING_FATIGUE, 7200, 0);
	public static final DreamWeave WEAVE_SATURATION = new DreamWeave("weave_saturation", MobEffects.SATURATION, MobEffects.HUNGER, 4800, 0);
	public static final DreamWeave WEAVE_NIGHTMARE = new DreamWeave("weave_nightmare", MobEffects.WEAKNESS, MobEffects.BLINDNESS, 1200, 0);
	public static final DreamWeave WEAVE_INTENSITY = new DreamWeave("weave_intensity", MobEffects.NIGHT_VISION, MobEffects.BLINDNESS, 300,0);
	...
	// Vampire
	// Cloth
	public static final VampireClothes CLOTH_VAMPIRE_HELMET = new VampireClothes("cloth_vampire_helmet", 1, EntityEquipmentSlot.HEAD, false, false);
	public static final VampireClothes CLOTH_VAMPIRE_MALE_CHESTPLATE = new VampireClothes("cloth_vampire_male_chestplate", 1, EntityEquipmentSlot.CHEST, false, false);
	public static final VampireClothes CLOTH_VAMPIRE_FEMALE_CHESTPLATE = new VampireClothes("cloth_vampire_female_chestplate", 1, EntityEquipmentSlot.CHEST, false, true);
	public static final VampireClothes CLOTH_VAMPIRE_LEGGINGS = new VampireClothes("cloth_vampire_leggings", 1, EntityEquipmentSlot.LEGS, false, false);
	public static final VampireClothes CLOTH_VAMPIRE_BOOTS = new VampireClothes("cloth_vampire_boots", 1, EntityEquipmentSlot.FEET, false, false);
	// Metal
	public static final VampireClothes HELMET_VAMPIRE = new VampireClothes("chain_vampire_helmet", 1, EntityEquipmentSlot.HEAD, true, false);
	public static final VampireClothes CHAIN_VAMPIRE_MALE_CHESTPLATE = new VampireClothes("chain_vampire_male_chestplate", 1, EntityEquipmentSlot.CHEST, true, false);
	public static final VampireClothes CHAIN_VAMPIRE_FEMALE_CHESTPLATE = new VampireClothes("chain_vampire_female_chestplate", 1, EntityEquipmentSlot.CHEST, true, true);
	public static final VampireClothes CHAIN_VAMPIRE_LEGGINGS = new VampireClothes("chain_vampire_leggings", 1, EntityEquipmentSlot.LEGS, true, false);
}
