...
public class StrokeSet {
	...
	public void addTo(Hashtable<ByteBuffer, SymbolEffect> table, Hashtable<ByteBuffer, Integer> enhanced,
			SymbolEffect effect) {
	...
	public static class Stroke {
		public static final byte UP = 0, DOWN = 1, LEFT = 3, RIGHT = 2, UP_LEFT = 6, UP_RIGHT = 4, DOWN_LEFT = 5,
				DOWN_RIGHT = 7;
