...
public class DimensionalLocation {
	...
	public DimensionalLocation(final NBTTagCompound nbtTag, final String prefix) {
		this(nbtTag.getInteger(prefix + "D"), nbtTag.getDouble(prefix + "X"), nbtTag.getDouble(prefix + "Y"), nbtTag.getDouble(prefix + "Z"),
				nbtTag.hasKey(prefix + "D") && nbtTag.hasKey(prefix + "X") && nbtTag.hasKey(prefix + "Y") && nbtTag.hasKey(prefix + "Z"));
	}
	...
	protected DimensionalLocation(final int dimension, final double posX, final double posY, final double posZ, final boolean isValid) {
