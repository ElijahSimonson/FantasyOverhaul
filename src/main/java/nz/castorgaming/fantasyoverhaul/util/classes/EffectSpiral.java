...
private final ISpiralBlockAction action;
    ...
    public void apply(final World world, final int midX, final int midY, final int midZ, final int dimX, final int dimZ) {
        ...
        for (int maxI = t * t, i = 0; i < maxI && (-dimX / 2 > x || x > dimX / 2 || -dimZ / 2 > z || z > dimZ / 2 || this.action.onSpiralBlockAction(world, midX + x, midY, midZ + z)); x += dx, z += dz, ++i) {
