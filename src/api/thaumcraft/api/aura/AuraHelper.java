...
public class AuraHelper {
	...
	/**
	 * Consume flux from the aura at the given location Added for completeness, but
	 * should really not be used. Add instability instead.
	 * 
	 * @param world
	 * @param pos
	 * @param amount
	 ...
	 * @param pos
	 * @param amount
	 *            how much stability to remove
	 * @param showEffect
	 *            if set to true, a flux smoke effect and sound will also be
	 *            displayed. Use in moderation.
	 */
	...
	/**
	 * Gets if the local aura for the given aspect is below 10% and that the player
	 * has the node preserver research. If the passed in player is null it will
	 * ignore the need for the research to be completed and just assume it is.
	 * 
	 * @param world
	 * @param player
	 * @param pos
