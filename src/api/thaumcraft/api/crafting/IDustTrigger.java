...
public interface IDustTrigger {
	...
	/**
	 * Checks to see if using dust on the passed in location and face will result in
	 * a valid operation. This is performed on client and server
	 * 
	 * @param world
	 * @param player
	 * @param pos
	 * @param face
	 * @return the placement offset (from clicked block) and facing (if used). Can
	 *         contain . Return Null if not valid
	 */
	...
	/**
	 * The operation to perfom if the location is valid. This is performed on client
	 * and server
	 * 
	 * @param world
	 * @param player
	...
	/**
	 * This method returns a list of block locations that should display the dust
	 * sparkle fx. By default it will return the block clicked on.
	 * 
	 * @param world
	 * @param player
	 * @param pos
