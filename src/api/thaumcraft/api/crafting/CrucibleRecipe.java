...
public class CrucibleRecipe implements ITCRecipe {
	...
	/**
	 * @param researchKey
	 *            the research key required for this recipe to work.<br>
	...
	public boolean matches(AspectList itags, ItemStack cat) {
		if (catalyst instanceof ItemStack && !OreDictionary.itemMatches((ItemStack) catalyst, cat, false)) {
			...
			if (!ThaumcraftApiHelper.containsMatch(false, new ItemStack[] { cat }, (List<ItemStack>) catalyst))
				return false;
		}
		if (itags == null)
			return false;
