...
public class InfusionRecipe implements ITCRecipe {
	...
	/**
	 * @param research
	 *            the research key required for this recipe to work. Leave blank if
	 *            it will work without research<br>
	 *            Can specify stage like IPlayerKnowledge.isResearchKnown
	 * @param result
	 *            the recipe output. It can either be an itemstack or an nbt
	 *            compound tag that will be added to the central item If nbt it
	 *            needs to be in the format Object[] {"nbttagname", NBT Tag Object}
	 *            eg. new Object[] { "mask", new NBTTagInt(1) }
	 * @param instability
	 ...
	 * @param aspects
	 *            input the central item to be infused. If string is passed it will
	 *            look up oredictionary entries
	 * @param recipe
	 *            An array of items required to craft this. Input itemstacks are NBT
	 *            sensitive. If string is passed it will look up oredictionary
	 *            entries.
	 */

	public InfusionRecipe(String research, Object output, int inst, AspectList aspects2, Object input,
			Object[] recipe) {
		this.name = "";
	...
	public boolean matches(ArrayList<ItemStack> input, ItemStack central, World world, EntityPlayer player) {
		...
		if (!ThaumcraftApiHelper.areItemStacksEqualForCrafting(i2, getRecipeInput()))
			return false;
