...
public interface IGolemAPI {
	 ...
	 * 
	 * @param stack
	 * @return anything left over that the golem could not hold. If the golem picked
	 *         up the entire stack this will be a null.
	 */
	public ItemStack holdItem(ItemStack stack);

	/**
	 * Causes the golem to remove an itemstack it is holding. It does not actually
	 * drop the item in the world or place it anywhere - that is up to whatever is
	 * calling this method.
	 * 
	 * @param stack
	 *            the itemstack that the golem will drop. If null is supplied the
	 *            golem will drop whatever it is holding
	 ...
	 * 
	 * @param stack
	 *            the stack the golem has room for - can be null
	 * @param partial
	 *            does the golem only need to have room for part of the stack?
	 * @return
	 */
	...
	/**
	 * Gives the golem xp towards increasing its rank rating. Default is usually 1
