...
public class ProvisionRequest {
	...
	public boolean equals(Object p_equals_1_) {
		if (this == p_equals_1_) {
			...
			return !this.seal.getSealPos().equals(pr.getSeal().getSealPos()) ? false
					: isItemStackEqual(this.stack, pr.getStack());
		}
	}
				...
				: (first.getItem() != other.getItem() ? false
						: (first.getItemDamage() != other.getItemDamage() ? false
								: (first.getTagCompound() == null && other.getTagCompound() != null ? false
										: first.getTagCompound() == null
												|| first.getTagCompound().equals(other.getTagCompound()))));
	}
}