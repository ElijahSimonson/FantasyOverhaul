...
public class GolemAddon {
	...
	public GolemAddon(String key, String[] research, ResourceLocation icon, PartModel model, Object[] comp,
			EnumGolemTrait[] tags) {
		this.key = key;
	...
	public GolemAddon(String key, String[] research, ResourceLocation icon, PartModel model, Object[] comp,
			IAddonFunction function, EnumGolemTrait[] tags) {
	...
	/**
	 * This optional interface allows you to create a class that will add
	 * functionality for a specific part.
	 */
