...
public class GolemArm {
	...
	public GolemArm(String key, String[] research, ResourceLocation icon, PartModel model, Object[] comp,
			EnumGolemTrait[] tags) {
		this.key = key;
	...
	public GolemArm(String key, String[] research, ResourceLocation icon, PartModel model, Object[] comp,
			IArmFunction function, EnumGolemTrait[] tags) {
	...
	/**
	 * This optional interface allows you to create a class that will be called
	 * whenever the golem makes a ranged (using IRangedAttackMob) or melee attack.
