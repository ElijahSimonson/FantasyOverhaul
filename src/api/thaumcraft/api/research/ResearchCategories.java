...
public class ResearchCategories {
	...
	/**
	 * @param key
	 * @return the name of the research category linked to this key. Must be stored
	 *         as localization information in the LanguageRegistry.
	 */
	 ...
	 * @param researchkey
	 *            the research that the player needs to have completed before this
	 *            category becomes visible. Set as null to always show.
	 * @param aspectsFormula
	 *            aspects required to gain knowledge in this category
	 * @param icon
	 ...
	 *            category
	 * @param background2
	 *            the resource location of the foreground image that lies between
	 *            the background and icons
	 * @return the registered category
	 */
	public static ResearchCategory registerCategory(String key, String researchkey, AspectList formula,
