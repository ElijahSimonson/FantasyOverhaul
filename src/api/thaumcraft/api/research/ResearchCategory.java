...
public class ResearchCategory {
	...
	public ResearchCategory(String key, String researchkey, AspectList formula, ResourceLocation icon,
	...
	public ResearchCategory(String key, String researchKey, AspectList formula, ResourceLocation icon,
			ResourceLocation background, ResourceLocation background2) {
		this.key = key;
		this.researchKey = researchKey;
		this.icon = icon;
		this.background = background;
	...
	/**
	 * For a given list of aspects this method will calculate the amount of raw
	 * knowledge you will be able to gain for the knowledge field.
	 * 
	 * @param as
	 * @return
	 */
	...
	/**
	 * This version of the method accepts a multiplier for the total - should
	 * usually not be needed by addon mods
	 * 
	 * @param as
	 * @param mod
	 *            multiplier to total
