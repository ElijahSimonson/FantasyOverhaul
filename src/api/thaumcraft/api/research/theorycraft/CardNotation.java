...
public class CardNotation extends TheorycraftCard {
	...
	public String getLocalizedText() {
		return new TextComponentTranslation("card.notation.text", new Object[] {
				TextFormatting.BOLD + new TextComponentTranslation("tc.research_category." + cat1).getFormattedText()
						+ TextFormatting.RESET,
				TextFormatting.BOLD + new TextComponentTranslation("tc.research_category." + cat2).getFormattedText()
