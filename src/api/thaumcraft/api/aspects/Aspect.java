...
public class Aspect {
	 ...
	 * 
	 * @param tag
	 *            the key that will be used to reference this aspect, as well as its
	 *            latin display name
	 * @param color
	 ...
	 * @param blend
	 *            GL11 blendmode (1 or 771). Used for rendering nodes. Default is 1
	 */
	...
	/**
	 * Shortcut constructor I use for the default aspects - you shouldn't be using
	 * this.
	 */
	public Aspect(String tag, int color, Aspect[] components) {
		this(tag, color, components,
				new ResourceLocation("thaumcraft", "textures/aspects/" + tag.toLowerCase() + ".png"), 1);
	}
	...
	public Aspect(String tag, int color, Aspect[] components, int blend) {
		this(tag, color, components,
				new ResourceLocation("thaumcraft", "textures/aspects/" + tag.toLowerCase() + ".png"), blend);
	}

	/**
	 * Shortcut constructor I use for the primal aspects - you shouldn't use this as
	 * making your own primal aspects will break all the things.
	 */
	...
	// public static final Aspect WEATHER = new Aspect("tempestas",0xFFFFFF, new
	// Aspect[] {AIR, WATER});
	// public static final Aspect ?? = new Aspect("??",0xcdccf4, new Aspect[] {FIRE,
	// EARTH});
	// public static final Aspect ?? = new Aspect("??",0xcdccf4, new Aspect[] {FIRE,
	// WATER});
