...
public class OreDictionaryEntries {
	...
	/**
	 * I included this in the API to make it simpler to see what items and blocks
	 * are ore dictionaried
	 */
	public static void initializeOreDictionary() {
		...
		OreDictionary.registerOre("oreCrystalEarth",
				new ItemStack(BlocksTC.crystalEarth, 1, OreDictionary.WILDCARD_VALUE));
		OreDictionary.registerOre("oreCrystalWater",
				new ItemStack(BlocksTC.crystalWater, 1, OreDictionary.WILDCARD_VALUE));
		OreDictionary.registerOre("oreCrystalFire",
				new ItemStack(BlocksTC.crystalFire, 1, OreDictionary.WILDCARD_VALUE));
		OreDictionary.registerOre("oreCrystalOrder",
				new ItemStack(BlocksTC.crystalOrder, 1, OreDictionary.WILDCARD_VALUE));
		OreDictionary.registerOre("oreCrystalEntropy",
				new ItemStack(BlocksTC.crystalEntropy, 1, OreDictionary.WILDCARD_VALUE));
		OreDictionary.registerOre("oreCrystalTaint",
				new ItemStack(BlocksTC.crystalTaint, 1, OreDictionary.WILDCARD_VALUE));
