 ...
 * @author Azanor
 * 
 *         Unless there are specific tasks you need to perform, you are better
 *         off using <b>completeResearch</b> and <b>addKnowledge</b> from the
 *         <b>IInternalMethodHandler</b>. It does most of the heavy lifting for
 *         you in regards to normal TC research. These methods are purely for
 *         manipulation of the players knowledge list without any checks or
 *         crosschecks.
 *
 */
public interface IPlayerKnowledge extends INBTSerializable<NBTTagCompound> {
	...
	/**
	 * @param research
	 *            The research to query.<br>
	 *            You may also pass in research as 'example@2'. This will check if
	 *            you know the research 'example' and if it is at least at stage
	 *            2<br>
	 *            Passing in an empty trying will always return true (used by
	 *            crafting recipes)
	 ...
	 * @param research
	 *            The research to query
	 * @return The stage you have progressed to. Stages start at 1 and research is
	 *         considered 'complete' if the set stage exceeds the number of stages
	 *         in the research entry. Returns 0 if research is known, but contains
	 *         no stages, -1 if research is not known at all.
	 */
	int getResearchStage(@Nonnull String research);

	/**
	 * In nearly ALL circumstances
	 * <code>IInternalMethodHandler.progressResearch</code> or
	 * <code>IInternalMethodHandler.completeResearch</code> should be used instead
	 * of this method. This simply sets the raw data without some of the other
	 * things required.
	 * 
	 * @param research
	 *            The research to add
	 ...
	 * 
	 * @param research
	 *            The research to modify
	 * @param stage
	 *            The stage to set it to
	 * @return Whether the operation was successful
	 */
	 ...
	 *            the research to update
	 * @param flag
	 *            the flag you wish to clear.
	 */
	boolean clearResearchFlag(@Nonnull String research, @Nonnull EnumResearchFlag flag);

	/**
	 * @param research
	 *            the research for which you want to check the flag status
	 * @param flag
	 *            the flag you wish to check.
	 */
	 ...
	 * should be used instead of this method. This simply sets the raw data without
	 * some of the other things required.
	 * 
	 * @param type
	 *            the knowledge type
	 * @param category
	 *            the knowledge category. Null value will map to the 'NONE' type
	 * @param amount
	 *            how much raw knowledge points to add. Can be negative
	 ...
	 *            the knowledge type
	 * @param field
	 *            the knowledge field. Null value will map to the 'NONE' type
	 * @return returns knowledge points divided by progression rounded down. In
	 *         other words, the full amount of knowledge the player has of that
	 *         type.
	 */
	...
	public enum EnumKnowledgeType {
		THEORY(32, true, "T"), OBSERVATION(16, true, "O"), EPIPHANY(256, false, "E");
	...
	public enum EnumResearchFlag {
		...
		RESEARCH,
		/**
		 * This research should trigger a GUI popup when synced. Flag will be cleared
		 * once sync occurs
		 */
		POPUP;
	}
