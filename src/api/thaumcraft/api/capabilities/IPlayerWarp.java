 ...
 *         off using <b>addWarpToPlayer</b> from the
...
public interface IPlayerWarp extends INBTSerializable<NBTTagCompound> {
	...
	/**
	 * @param type
	 *            The type of warp to set
	 * @param amount
	 *            how much to set it to
	 */
	...
	/**
	 * @param amount
	 *            how much to set the counter it to
	 */
