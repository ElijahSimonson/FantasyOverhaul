...
public class FocusHelper {
	 ...
	 * @param connections
	 *            what other parts this part can connect to. By default all
	 *            'effects' & 'mediums' can connect so this does not need to be
	 *            listed
	 * @return
	 */
	...
	public static boolean canPartsConnect(IFocusPart part1, IFocusPart part2) {
		...
		if (part1.getType() == EnumFocusPartType.MEDIUM && part2.getType() == EnumFocusPartType.EFFECT
				|| part2.getType() == EnumFocusPartType.MEDIUM && part1.getType() == EnumFocusPartType.EFFECT)
			return true;
